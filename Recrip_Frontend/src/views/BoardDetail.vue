			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-md-10 col-sm-12">
					<h2 class="my-3 py-3 shadow-sm bg-light text-center">
						<mark class="sky" id="subject">{{article.subject}}</mark>
					</h2>
				</div>
				<div class="col-lg-8 col-md-10 col-sm-12">
					<div class="row">
						<div class="col-md-8">
							<div class="clearfix align-content-center">
								...
								<p>
									...
									<span class="text-secondary fw-light" id="date"> {{article.date}}
									</span>
								</p>
							</div>
						</div>
						...
						<div class="d-flex justify-content-end">
                            ...
                            <template v-if="userinfo.userid == article.userid">
                                ...
                                <button type="button" class="btn btn-outline-danger mb-3 ms-1" @click="DeleteBoard">글삭제</button>
							</template>
						</div>
					</div>
				</div>
                    ...
                    <form id="comment" class="col-lg-8 col-md-10 col-sm-12">
                        <div class="input-group mb-3">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="height: 150px" v-model="comment"></textarea>
                            ...
                            <template v-if="IsLogin == true">
                                <template v-if="userinfo.userid == comment.userid">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        id="btn-cm-delete" @click="CommentDelete(comment.commentno)">댓글삭제</button>
                                    </div>
                                </template>
                            </template>
							<!-- </c:if> -->
